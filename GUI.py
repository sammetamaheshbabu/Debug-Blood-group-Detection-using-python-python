...
class Login(Frame):
    ...
    def init_window(self):
        ...
        stage.add_command(
            label="Process 3: Adaptive Threshold:Ni Black", command=self.Adapthresh
        )
        stage.add_command(
            label="Process 4: Morphology: Fill Holes", command=self.Fill_holes
        )
        stage.add_command(
            label="Process 5: Advanced Morphology: Remove small objects",
            command=self.Remove_small_objects,
        )
        ...
        self.ep = Button(
            self, text="Process", font=("Helvetica", 12), fg="red", relief=SUNKEN
        )
    ...
    def imagesel1(self):
        ...
        r = self.p.resize((300, 425), Image.LANCZOS)
    ...
    def check(self):
        if blood[3] == True:
            ...
            blood[0] is False
            and blood[1] is False
            and blood[2] is True
            and blood[3] is False
        ):
            self.message("O+")
        elif (
            blood[0] is False
            and blood[1] is False
            and blood[2] is False
            and blood[3] is False
        ):
            self.message("O-")
        elif (
    ...
    def gp(self):
        im1 = cv2.imread("./src/p1Anti_A.png")
        cv2.imshow("Anti-A", im1)
        im2 = cv2.imread("./src/p1Anti_B.png")
        cv2.imshow("Anti-B", im2)
        im3 = cv2.imread("./src/p1Anti_D.png")
        cv2.imshow("Anti-D", im3)
        im4 = cv2.imread("./src/p1Control.png")
        cv2.imshow("Control", im4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()

    def autothresh(self):
        im1 = cv2.imread("./src/p2Anti_A.png")
        cv2.imshow("Anti-A", im1)
        im2 = cv2.imread("./src/p2Anti_B.png")
        cv2.imshow("Anti-B", im2)
        im3 = cv2.imread("./src/p2Anti_D.png")
        cv2.imshow("Anti-D", im3)
        im4 = cv2.imread("./src/p2Control.png")
        cv2.imshow("Control", im4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()

    def Adapthresh(self):
        im1 = cv2.imread("./src/p3Anti_A.png")
        cv2.imshow("Anti-A", im1)
        im2 = cv2.imread("./src/p3Anti_B.png")
        cv2.imshow("Anti-B", im2)
        im3 = cv2.imread("./src/p3Anti_D.png")
        cv2.imshow("Anti-D", im3)
        im4 = cv2.imread("./src/p3Control.png")
        cv2.imshow("Control", im4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()

    def Fill_holes(self):
        im1 = cv2.imread("./src/p4Anti_A.png")
        cv2.imshow("Anti-A", im1)
        im2 = cv2.imread("./src/p4Anti_B.png")
        cv2.imshow("Anti-B", im2)
        im3 = cv2.imread("./src/p4Anti_D.png")
        cv2.imshow("Anti-D", im3)
        im4 = cv2.imread("./src/p4Control.png")
        cv2.imshow("Control", im4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()

    def Remove_small_objects(self):
        im1 = cv2.imread("./src/p5Anti_A.png")
        cv2.imshow("Anti-A", im1)
        im2 = cv2.imread("./src/p5Anti_B.png")
        cv2.imshow("Anti-B", im2)
        im3 = cv2.imread("./src/p5Anti_D.png")
        cv2.imshow("Anti-D", im3)
        im4 = cv2.imread("./src/p5Control.png")
        cv2.imshow("Control", im4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()

    def Histogram(self):
        img1 = cv2.imread("./src/p5Anti_A.png", 0)
        img2 = cv2.imread("./src/p5Anti_B.png", 0)
        img3 = cv2.imread("./src/p5Anti_D.png", 0)
        img4 = cv2.imread("./src/p5Control.png", 0)
